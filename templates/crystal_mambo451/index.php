...
//$database->setQuery("SELECT * FROM #__menu WHERE menutype = 'translation menu' AND published ='1' AND parent = '0' ORDER BY ordering");
...
<tr><td colspan="3" bgcolor="#838EBF" height="15"><h3>COAddOns project site-Add-Ons for MiaCMS, Mambo &amp; Joomla CMS</h3>&nbsp;<?php mosPathWay(); ?></td></tr>
<tr>
...
<tr>
    <td align="center" valign="middle" colspan="3" bgcolor="#838EBF" height="15">
...
<!--INFOLINKS_OFF-->
    ...
    <table width="96%" cellpadding="0" cellspacing="0" align="center">
    <tr> <td> <?php mosLoadModules('bottom'); ?> </td> </tr>
    </table>
    <?php } ?>
...
<div align="center">
<?php // if (file_exists("display.php")) { include("display.php"); } ?>
</div>
...
<?php  
if (file_exists("mosmodule/ga.php")) { include("mosmodule/ga.php"); }
?>
</body>
</html>
