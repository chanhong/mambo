...
<link href="<?php echo $mosConfig_live_site;?>/templates/waterandstone800_blue/css/template_css.css" rel="stylesheet" type="text/css"/>
</head>
...
<div id="container">
	<div id="containerbg">
		<div id="outerleft">
			<!-- start logo -->
			<div id="logo">
			  <a href="index.php"><img src="<?php echo $mosConfig_live_site; ?>/templates/waterandstone800_blue/images/logo.gif" alt="logo image" border="0" align="top" /></a>
			</div>
			<!-- end logo -->
			...
			<!-- start image header -->
			<div id="imgheader">
			<img src="<?php echo $mosConfig_live_site; ?>/templates/waterandstone800_blue/images/img_header.jpg" alt="header image" />
			</div>
			<!-- end image header -->
