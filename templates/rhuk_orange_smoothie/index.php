...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	...
	<table width="898"  border="0" cellpadding="0" cellspacing="0">
		<tr>
		<td background="<?php echo $mosConfig_live_site;?>/templates/rhuk_orange_smoothie/images/generic_header.jpg" /><img src="<?php echo $mosConfig_live_site;?>/templates/rhuk_orange_smoothie/images/spacer.gif" width="5" height="98" align="absmiddle"/><span class="sitetitle"><?php echo $mosConfig_sitename; ?> </span>
<?php mosLoadComponent( "banners" ); ?></td>
		</tr>
<!-- searchbox -->
		<tr>
