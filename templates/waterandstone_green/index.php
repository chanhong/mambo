...
<link href="<?php echo $mosConfig_live_site;?>/templates/waterandstone_green/css/template_css.css" rel="stylesheet" type="text/css"/>
</head>
...
<div id="container">
	<div id="containerbg">
		<div id="outerleft">
			<!-- start logo -->
			<div id="logo">
			  <a href="index.php"><img src="<?php echo $mosConfig_live_site; ?>/templates/waterandstone_green/images/logo.gif" alt="logo image" border="0" align="top" /></a>
			</div>
			<!-- end logo -->
			<!-- start top menu -->
			<div id="topmenu">
