 ...
 * File:        rss_fetch.php, a simple functional interface
...
require_once( MAGPIE_DIR . 'rss_parse.php' );
require_once( MAGPIE_DIR . 'rss_cache.php' );
 ...
 * feel to Magpie, see rss_cache.php for rationale
 *
 *
...
/*=======================================================================*\
    ...
    Output:   parsed RSS object (see rss_parse.php)
...
/*=======================================================================*\
    ...
    Output:     an HTTP response object (see Snoopy.class.php)
\*=======================================================================*/
...
function init () {
    ...
    if ( !defined('MAGPIE_FETCH_TIME_OUT') ) {
        define('MAGPIE_FETCH_TIME_OUT', 25); // 25 second timeout
    }
