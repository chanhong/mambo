...
if (!defined('_DATE_FORMAT_LC2')) DEFINE('_DATE_FORMAT_LC2',"%A, %d %B %Y %H:%M");
...
DEFINE('_VALID_AZ09',"Please enter a valid %s.  No spaces, more than %d characters and containing only the characters 0-9,a-z, or A-Z");
DEFINE('_CMN_YES','Yes');
DEFINE('_CMN_NO','No');
...
DEFINE('_LOGIN_NOAUTHENTICS','Logins are not permitted.  There is no authentication check active.');
...
DEFINE('_SEL_CATEGORY','- All Categories -');
DEFINE('_SEL_SECTION','- All Sections -');
DEFINE('_SEL_AUTHOR','- All Authors -');
DEFINE('_SEL_POSITION','- All Positions -');
DEFINE('_SEL_TYPE','- All Types -');
...
DEFINE('_LOST_PASSWORD','Password Reminder');
...
DEFINE('_COPY_TEXT','The following is a copy of the message you sent to %s via %s ');
...
DEFINE('_EMAIL_ERR_NOINFO','You must enter valid e-mail addresses for both yourself and your recipient.');
...
DEFINE('_E_ITEM_SAVED','Item saved successfully.');
DEFINE('_ITEM_PREVIOUS','&lt; Previous');
DEFINE('_ITEM_NEXT','Next &gt;');


/** content.php */
DEFINE('_SECTION_ARCHIVE_EMPTY','There are currently no Archived Entries for this Section');
DEFINE('_CATEGORY_ARCHIVE_EMPTY','There are currently no Archived Entries for this Category');
...
DEFINE('_REGWARN_PASS','Please enter a valid password -- more than 6 characters with no spaces and containing only the characters 0-9, a-z, or A-Z');
...
DEFINE('_REGWARN_INUSE','This username/password is already in use. Please try another.');
DEFINE('_REGWARN_EMAIL_INUSE', 'This e-mail is already registered. If you forgot the password click on "Password Reminder" and new password will be sent to you.');
...
DEFINE('_REG_COMPLETE_ACTIVATE', '<div class="componentheading">Registration Complete</div><br />Your account has been created and an activation link has been sent to the e-mail address you entered. Note that you must activate the account by clicking on the activation link before you can login.');
DEFINE('_REG_ACTIVATE_COMPLETE', '<div class="componentheading">Activation Complete!</div><br />Your account has been activated successfully. You can now login using the username and password you chose during registration.');
...
.'You will receive a new password shortly.  Use the new password to access the site.');
...
.' new password you can login and change it, if you so desire.');
...
DEFINE('_THANK_SUB','Thanks for your submission; it will be reviewed before being posted to the site.');
...
DEFINE('_SUBMIT_SUCCESS_DESC','Your item has been submitted to the site administrators. It will be reviewed before being published on the site.');
DEFINE('_WELCOME','Welcome!');
DEFINE('_WELCOME_DESC','Welcome to the user section of our site');
DEFINE('_CONF_CHECKED_IN','All items checked out have now been checked in');
...
DEFINE('_LOGIN_SUCCESS','You have Logged In succesfully');
DEFINE('_LOGOUT_SUCCESS','You have Logged Out successfully ');
DEFINE('_LOGIN_DESCRIPTION','To access the Private areas of this site please Login');
DEFINE('_LOGOUT_DESCRIPTION','You are now Logged in to a private area of this site');


/** components/com_weblinks */
DEFINE('_WEBLINKS_TITLE','Web Links');
DEFINE('_WEBLINKS_DESC','From the list below choose one of our web link categories, then select a URL to visit the site.');
...
DEFINE('_NAME','Name:');
DEFINE('_WEBLINK_EXIST','There is already a web link that name, please try again.');
DEFINE('_WEBLINK_TITLE','Your web link must be given a title.');
...
DEFINE('_MAINMENU_DEL','* You cannot `delete` this menu as it is required for the proper operation of Mambo *');
