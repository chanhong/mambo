...
if (!defined("PCLERROR_LIB"))
{
  ...
  function PclErrorFatal($p_file, $p_line, $p_error_string="")
  {
    ...
    $v_message =  "<html><body>";
    $v_message .= "<p align=center><font color=red bgcolor=white><strong>PclError Library has detected a fatal error on file '$p_file', line $p_line</strong></font></p>";
    $v_message .= "<p align=center><font color=red bgcolor=white><strong>$p_error_string</strong></font></p>";
    $v_message .= "</body></html>";
    die($v_message);
  }
  // --------------------------------------------------------------------------------
