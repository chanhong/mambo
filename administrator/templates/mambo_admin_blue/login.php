...
<div id="ctr" align="center">
	<div class="login">
		<div class="login-form">
			<img src="templates/mambo_admin_blue/images/login.gif" alt="<?php echo T_('Login') ?>" />
...
<div id="break"></div>
<noscript>
<?php echo T_('!Warning! Javascript must be enabled for proper operation of the Administrator'); ?>
</noscript>
