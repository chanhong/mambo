	...
	function edit( &$menu, &$lists, &$params, $option ) {
		...
		function submitbutton(pressbutton) {
			...
			if ( trim(form.name.value) == "" ){
				...
				alert( "<?php echo T_('You must select a Component to link to'); ?>" );
			} else {
				submitform( pressbutton );
			}
		}
		...
		<tr>
			<th>
			<?php echo $menu->id ? T_('Edit') : T_('Add');?> <?php echo T_('Menu Item :: Link - Component Item'); ?>
			</th>
		</tr>
		</table>
