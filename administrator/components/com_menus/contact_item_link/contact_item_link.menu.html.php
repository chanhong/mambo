	...
	function edit( &$menu, &$lists, &$params, $option, $contact ) {
		...
		function submitbutton(pressbutton) {
			...
			if (trim(form.name.value) == ""){
				...
				alert( "<?php echo T_('You must select a Contact to link to'); ?>" );
			} else {
		...
		<tr>
			<th>
			<?php echo $menu->id ? T_('Edit') : T_('Add');?> <?php echo T_('Menu Item :: Link - Contact Item'); ?>
			</th>
		</tr>
		</table>
