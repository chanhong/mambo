...
class mosConfig extends mosDBTable {
	...
	/** @var string */
	var $config_locale_debug=0;
	/** @var string */
	var $config_locale_use_gettext=0;
	/** @var string */
	...
	function mosConfig() {
		...
		'config_use_captcha'			=>'mosConfig_usecaptcha',
		...
		'config_locale_debug'			=>'mosConfig_locale_debug',
		'config_locale_use_gettext'		=>'mosConfig_locale_use_gettext',
...
//	$menuitems = array_merge( $menuitems, $database->loadObjectList() );
	...
	$locale_use_gettext = array(
		mosHTML::makeOption( 1, T_('Yes') ),
		mosHTML::makeOption( 0, T_('No') ),
	);
