...
class HTML_trash {
	...
	*/
	function showList( $option, $contents, $menus, $pageNav_content, $pageNav_menu ) {
		...
		*/
		...
		<tr>
			<th class="trash"><?php echo T_('Trash Manager'); ?></th>
		</tr>
		</table>
		...
		<tr>
			<th><small><?php echo T_('Content Items'); ?></small></th>
		</tr>
		</table>
		...
		foreach ( $menus as $row ) {
			?>
			<input type="checkbox" style="visibility:hidden;" id="dcb<?php echo $i;?>" name="mid[]" value="<?php echo $row->id; ?>">
			<?php
			$i++;
			}
			?>
		...
		<table class="adminheading" width="90%">
		<tr>
			<th><small><?php echo T_('Menu Items'); ?></small></th>
		</tr>
		</table>
		...
		foreach ( $menus as $row ) {
			...
			<tr class="<?php echo "row". $k; ?>">
				...
				<input type="checkbox" id="cb1<?php echo $i;?>" name="mid[]" value="<?php echo $row->id; ?>" onclick="isChecked(this.checked);document.getElementById('dcb<?php echo $i;?>').checked=this.checked;" />
				</td>
				<td width="20px"></td>
				<td nowrap>
				<?php
	...
	*/
	...
	?>
		...
		<table class="adminheading">
		<tr>
			<th><?php echo T_('Delete Items'); ?></th>
		</tr>
		</table>
		...
		<tr>
			...
			<strong><?php echo T_('Number of Items:'); ?></strong>
			<br />
			<font color="#000066"><strong><?php echo count( $cid ); ?></strong></font>
			<br /><br />
			</td>
			<td align="left" valign="top" width="25%">
			<strong><?php echo T_('Items being Deleted:'); ?></strong>
			<br />
			<?php
			echo "<ol>";
			...
			?>
			 ...
			 <td valign="top">
			* <?php echo T_('This will <strong><font color="#FF0000">Permanently Delete</font></strong> <br />these Items from the Database'); ?> *
			<br /><br /><br />
	...
	*/
	...
	?>
		...
		<table class="adminheading">
		<tr>
			<th><?php echo T_('Restore Items'); ?></th>
		</tr>
		</table>
		...
		<tr>
			...
			* <?php echo T_('This will <strong><font color="#FF0000">Restore</font></strong> these Items,<br />they will be returned to their orignial places as Unpublished items'); ?> *
			...
			<img name="restore" src="images/restore.png" alt="<?php echo T_('Restore'); ?>" border="0" align="middle" />
			&nbsp;<?php echo T_('Restore'); ?>
			</a>
			</div>
			</td>
